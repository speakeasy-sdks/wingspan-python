...
res = s.collaborator_group_eligibility_requirement.delete(eligibility_requirement_id='libero', id='nobis')
...
res = s.collaborator_group_eligibility_requirement.replace(eligibility_requirement_id='dolores', id='quis', collaborator_group_requirement_update=shared.CollaboratorGroupRequirementUpdate(
    new_eligibility_requirement_id='totam',
))
