...
class FormW9:
    ...
    def download(self, id: str) -> operations.DownloadFormW9Response:
        ...
        hook_ctx = HookContext(operation_id='downloadFormW9', oauth2_scopes=[], security_source=None)
        ...
        res = operations.DownloadFormW9Response(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
