...
class InvoiceAsClient:
    ...
    def create(self, request: Optional[shared.ClientInvoiceCreateRequest]) -> operations.CreateInvoiceAsClientResponse:
        ...
        hook_ctx = HookContext(operation_id='createInvoiceAsClient', oauth2_scopes=[], security_source=None)
        ...
        res = operations.CreateInvoiceAsClientResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
