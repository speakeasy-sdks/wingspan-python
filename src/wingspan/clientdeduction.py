...
class ClientDeduction:
    ...
    def create(self, request: Optional[shared.DeductionCreateRequest]) -> operations.CreateClientDeductionResponse:
        r"""Create deduction"""
        hook_ctx = HookContext(operation_id='createClientDeduction', oauth2_scopes=[], security_source=None)
        ...
        res = operations.CreateClientDeductionResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
