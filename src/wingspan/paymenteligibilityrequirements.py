...
class PaymentEligibilityRequirements:
    ...
    def list(self) -> operations.ListPaymentEligibilityRequirementsResponse:
        ...
        hook_ctx = HookContext(operation_id='listPaymentEligibilityRequirements', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListPaymentEligibilityRequirementsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
