...
class AppLink:
    ...
    def get(self, member_id: str) -> operations.GetAppLinkResponse:
        ...
        hook_ctx = HookContext(operation_id='getAppLink', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetAppLinkResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
