...
class BulkInvoiceBatchItems:
    ...
    def list(self, batch_id: str) -> operations.ListBulkInvoiceBatchItemsResponse:
        ...
        hook_ctx = HookContext(operation_id='listBulkInvoiceBatchItems', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListBulkInvoiceBatchItemsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
