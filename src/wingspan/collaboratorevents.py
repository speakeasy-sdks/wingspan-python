...
class CollaboratorEvents:
    ...
    def get(self, id: str) -> operations.GetCollaboratorEventsResponse:
        ...
        hook_ctx = HookContext(operation_id='getCollaboratorEvents', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetCollaboratorEventsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
