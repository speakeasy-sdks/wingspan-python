...
class Collaborators:
    ...
    def list(self) -> operations.ListCollaboratorsResponse:
        ...
        hook_ctx = HookContext(operation_id='listCollaborators', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListCollaboratorsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
