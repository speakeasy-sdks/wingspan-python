...
class Form1099:
    ...
    def download(self, id: str, index: str, year: str) -> operations.DownloadForm1099Response:
        ...
        hook_ctx = HookContext(operation_id='downloadForm1099', oauth2_scopes=[], security_source=None)
        ...
        res = operations.DownloadForm1099Response(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
