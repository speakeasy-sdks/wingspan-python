...
class Cards:
    ...
    def list(self) -> operations.ListCardsResponse:
        r"""List cards"""
        hook_ctx = HookContext(operation_id='listCards', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListCardsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
