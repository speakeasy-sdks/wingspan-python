...
class BulkCalculation1099Batches:
    ...
    def list(self) -> operations.ListBulkCalculation1099BatchesResponse:
        ...
        hook_ctx = HookContext(operation_id='listBulkCalculation1099Batches', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListBulkCalculation1099BatchesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
