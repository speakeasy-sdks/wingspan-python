...
class CollaboratorGroup:
    ...
    def create(self, request: Optional[shared.CollaboratorGroupCreateRequest]) -> operations.CreateCollaboratorGroupResponse:
        ...
        hook_ctx = HookContext(operation_id='createCollaboratorGroup', oauth2_scopes=[], security_source=None)
        ...
        res = operations.CreateCollaboratorGroupResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get(self, id: str) -> operations.GetCollaboratorGroupResponse:
        ...
        hook_ctx = HookContext(operation_id='getCollaboratorGroup', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetCollaboratorGroupResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, id: str, collaborator_group_update_request: Optional[shared.CollaboratorGroupUpdateRequest] = None) -> operations.UpdateCollaboratorGroupResponse:
        ...
        hook_ctx = HookContext(operation_id='updateCollaboratorGroup', oauth2_scopes=[], security_source=None)
        ...
        res = operations.UpdateCollaboratorGroupResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
