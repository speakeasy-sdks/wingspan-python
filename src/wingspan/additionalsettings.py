...
class AdditionalSettings:
    ...
    def list(self) -> operations.ListAdditionalSettingsResponse:
        ...
        res = operations.ListAdditionalSettingsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, id: str, additional_data_update_request: Optional[shared.AdditionalDataUpdateRequest] = None) -> operations.UpdateAdditionalSettingsResponse:
        ...
        res = operations.UpdateAdditionalSettingsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
