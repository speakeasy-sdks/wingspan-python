...
class EligibilityRequirements:
    ...
    def list(self) -> operations.ListEligibilityRequirementsResponse:
        ...
        hook_ctx = HookContext(operation_id='listEligibilityRequirements', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListEligibilityRequirementsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
