...
class CollaboratorV2:
    ...
    def get(self, member_id: str) -> operations.GetCollaboratorV2Response:
        ...
        hook_ctx = HookContext(operation_id='getCollaboratorV2', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetCollaboratorV2Response(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
