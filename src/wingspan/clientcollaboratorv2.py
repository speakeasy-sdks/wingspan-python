...
class ClientCollaboratorV2:
    ...
    def get(self, client_id: str) -> operations.GetClientCollaboratorV2Response:
        ...
        hook_ctx = HookContext(operation_id='getClientCollaboratorV2', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetClientCollaboratorV2Response(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
