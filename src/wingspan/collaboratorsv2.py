...
class CollaboratorsV2:
    ...
    def list(self) -> operations.ListCollaboratorsV2Response:
        ...
        hook_ctx = HookContext(operation_id='listCollaboratorsV2', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListCollaboratorsV2Response(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
