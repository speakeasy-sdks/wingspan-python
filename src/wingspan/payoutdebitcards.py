...
class PayoutDebitCards:
    ...
    def list(self, member_id: str) -> operations.ListPayoutDebitCardsResponse:
        ...
        hook_ctx = HookContext(operation_id='listPayoutDebitCards', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListPayoutDebitCardsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
