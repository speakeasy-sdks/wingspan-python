...
class ClientInvoiceTemplate:
    ...
    def create(self, request: Optional[shared.ClientInvoiceTemplateCreateRequest]) -> operations.CreateClientInvoiceTemplateResponse:
        ...
        res = operations.CreateClientInvoiceTemplateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get(self, id: str) -> operations.GetClientInvoiceTemplateResponse:
        ...
        res = operations.GetClientInvoiceTemplateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, id: str, client_invoice_template_update_request: Optional[shared.ClientInvoiceTemplateUpdateRequest] = None) -> operations.UpdateClientInvoiceTemplateResponse:
        ...
        res = operations.UpdateClientInvoiceTemplateResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
