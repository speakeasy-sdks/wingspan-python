...
class Invoice:
    ...
    def generate(self, invoice_id: str) -> operations.GenerateInvoiceResponse:
        ...
        res = operations.GenerateInvoiceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def send(self, invoice_id: str) -> operations.SendInvoiceResponse:
        ...
        res = operations.SendInvoiceResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
