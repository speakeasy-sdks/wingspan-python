...
class FundsTransferAccountCurrency(str, Enum):
    USD = 'USD'
    CAD = 'CAD'

class FundsTransferAccountType(str, Enum):
    CARD = 'Card'
...
class FundsTransferAccount:
    ...
    currency: FundsTransferAccountCurrency = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('currency') }})
    ...
    type: FundsTransferAccountType = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('type') }})
