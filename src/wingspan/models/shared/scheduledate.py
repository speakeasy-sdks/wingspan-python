...
class ScheduleDate:
    ...
    cut_off_date: Optional[str] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('cutOffDate'), 'exclude': lambda f: f is None }})
