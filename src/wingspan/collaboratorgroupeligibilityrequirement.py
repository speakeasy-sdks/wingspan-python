...
class CollaboratorGroupEligibilityRequirement:
    ...
    def delete(self, eligibility_requirement_id: str, id: str) -> operations.DeleteCollaboratorGroupEligibilityRequirementResponse:
        ...
        hook_ctx = HookContext(operation_id='deleteCollaboratorGroupEligibilityRequirement', oauth2_scopes=[], security_source=None)
        ...
        res = operations.DeleteCollaboratorGroupEligibilityRequirementResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def replace(self, eligibility_requirement_id: str, id: str, collaborator_group_requirement_update: Optional[shared.CollaboratorGroupRequirementUpdate] = None) -> operations.ReplaceCollaboratorGroupEligibilityRequirementResponse:
        ...
        hook_ctx = HookContext(operation_id='replaceCollaboratorGroupEligibilityRequirement', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ReplaceCollaboratorGroupEligibilityRequirementResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
