...
class ClientInvoiceFees:
    ...
    def create(self, request: Optional[shared.TestInvoiceCreate]) -> operations.CreateClientInvoiceFeesResponse:
        ...
        res = operations.CreateClientInvoiceFeesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def list(self, invoice_id: str) -> operations.ListClientInvoiceFeesResponse:
        ...
        res = operations.ListClientInvoiceFeesResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
