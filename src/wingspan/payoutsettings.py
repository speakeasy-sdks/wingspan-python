...
class PayoutSettings:
    ...
    def get(self, id: str) -> operations.GetPayoutSettingsResponse:
        ...
        hook_ctx = HookContext(operation_id='getPayoutSettings', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetPayoutSettingsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, id: str, payout_settings_update: Optional[shared.PayoutSettingsUpdate] = None) -> operations.UpdatePayoutSettingsResponse:
        ...
        hook_ctx = HookContext(operation_id='updatePayoutSettings', oauth2_scopes=[], security_source=None)
        ...
        res = operations.UpdatePayoutSettingsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
