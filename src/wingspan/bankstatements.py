...
class BankStatements:
    ...
    def list(self) -> operations.ListBankStatementsResponse:
        ...
        hook_ctx = HookContext(operation_id='listBankStatements', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListBankStatementsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
