...
class PayableOnClient:
    ...
    def create(self, request: Optional[shared.PayableCreateRequest]) -> operations.CreatePayableOnClientResponse:
        ...
        hook_ctx = HookContext(operation_id='createPayableOnClient', oauth2_scopes=[], security_source=None)
        ...
        res = operations.CreatePayableOnClientResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, id: str, payable_update_request: Optional[shared.PayableUpdateRequest] = None) -> operations.UpdatePayableOnClientResponse:
        ...
        hook_ctx = HookContext(operation_id='updatePayableOnClient', oauth2_scopes=[], security_source=None)
        ...
        res = operations.UpdatePayableOnClientResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
