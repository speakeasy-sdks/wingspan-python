...
class Institution:
    ...
    def get(self, routing_number: str) -> operations.GetInstitutionResponse:
        ...
        hook_ctx = HookContext(operation_id='getInstitution', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetInstitutionResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
