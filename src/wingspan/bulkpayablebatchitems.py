...
class BulkPayableBatchItems:
    ...
    def list(self, batch_id: str) -> operations.ListBulkPayableBatchItemsResponse:
        ...
        hook_ctx = HookContext(operation_id='listBulkPayableBatchItems', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListBulkPayableBatchItemsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
