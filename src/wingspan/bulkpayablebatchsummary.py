...
class BulkPayableBatchSummary:
    ...
    def get(self, batch_id: str) -> operations.GetBulkPayableBatchSummaryResponse:
        ...
        hook_ctx = HookContext(operation_id='getBulkPayableBatchSummary', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetBulkPayableBatchSummaryResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
