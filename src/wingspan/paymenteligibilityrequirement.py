...
class PaymentEligibilityRequirement:
    ...
    def create(self, request: Optional[shared.PaymentEligibility]) -> operations.CreatePaymentEligibilityRequirementResponse:
        ...
        res = operations.CreatePaymentEligibilityRequirementResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def delete(self, id: str) -> operations.DeletePaymentEligibilityRequirementResponse:
        ...
        res = operations.DeletePaymentEligibilityRequirementResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get(self, id: str) -> operations.GetPaymentEligibilityRequirementResponse:
        ...
        res = operations.GetPaymentEligibilityRequirementResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, id: str, payment_eligibility_update_request: Optional[shared.PaymentEligibilityUpdateRequest] = None) -> operations.UpdatePaymentEligibilityRequirementResponse:
        ...
        res = operations.UpdatePaymentEligibilityRequirementResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
