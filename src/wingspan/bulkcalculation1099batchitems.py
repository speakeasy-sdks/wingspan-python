...
class BulkCalculation1099BatchItems:
    ...
    def list(self, batch_id: str) -> operations.ListBulkCalculation1099BatchItemsResponse:
        ...
        hook_ctx = HookContext(operation_id='listBulkCalculation1099BatchItems', oauth2_scopes=[], security_source=None)
        ...
        res = operations.ListBulkCalculation1099BatchItemsResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
