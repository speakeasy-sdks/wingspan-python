...
class BulkInvoiceBatch:
    ...
    def create(self, request: Optional[shared.BulkInvoiceBatchCreate]) -> operations.CreateBulkInvoiceBatchResponse:
        ...
        hook_ctx = HookContext(operation_id='createBulkInvoiceBatch', oauth2_scopes=[], security_source=None)
        ...
        res = operations.CreateBulkInvoiceBatchResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def get(self, batch_id: str) -> operations.GetBulkInvoiceBatchResponse:
        ...
        hook_ctx = HookContext(operation_id='getBulkInvoiceBatch', oauth2_scopes=[], security_source=None)
        ...
        res = operations.GetBulkInvoiceBatchResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
    ...
    def update(self, batch_id: str, bulk_invoice_batch_update: Optional[shared.BulkInvoiceBatchUpdate] = None) -> operations.UpdateBulkInvoiceBatchResponse:
        ...
        hook_ctx = HookContext(operation_id='updateBulkInvoiceBatch', oauth2_scopes=[], security_source=None)
        ...
        res = operations.UpdateBulkInvoiceBatchResponse(status_code=http_res.status_code, content_type=http_res.headers.get('Content-Type'), raw_response=http_res)
