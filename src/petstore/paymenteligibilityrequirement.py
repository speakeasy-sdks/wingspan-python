...
class PaymentEligibilityRequirement:
    ...
    def delete(self, request: operations.DeletePaymentEligibilityRequirementRequest) -> operations.DeletePaymentEligibilityRequirementResponse:
    ...
    def get(self, request: operations.GetPaymentEligibilityRequirementRequest) -> operations.GetPaymentEligibilityRequirementResponse:
